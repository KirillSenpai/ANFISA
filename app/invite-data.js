export const INVITE = {
  ...
  dressText:
    "Нам будет очень приятно, если в ваших образах появятся светлые, молочные, песочные и приглушённые природные оттенки.",
  dressColors: ["#f2eee7", "#ddd4c7", "#c7b7a3", "#ad9b88", "#7d6d5f"],
